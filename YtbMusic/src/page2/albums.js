...
import { albumDetails } from "../components/list";

export const albumsMusic = async (slug) => {
    const data = await albumDetails(slug)
    console.log(data.tracks);
    
    const albumsHTML = (data.tracks).map((detail, index) => `
